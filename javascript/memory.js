...
(function (window) {
	...
	Memory.prototype.options = {
		...
		cards: [
			{
				id: 1,
				img: "lib/img/Card/Card_01.png"
      },
			{
				id: 2,
				img: "lib/img/Card/Card_02.png"
      },
			{
				id: 3,
				img: "lib/img/Card/Card_03.png"
      },
			{
				id: 4,
				img: "lib/img/Card/Card_04.png"
      },
			{
				id: 5,
				img: "lib/img/Card/Card_05.png"
      },
			{
				id: 6,
				img: "lib/img/Card/Card_06.png"
      },
    ],
...
//<button id="home_button" class="button" onclick="game_GoTo_Home()" style="opacity: 0;top: 1675px; left: 387px; position: fixed;"><img src="./lib/breadtalk/image/home_button.png"></button>
		this.gameStartScreenHTML = '<ul class="mg__start-screen--level-select mg__button">\
									<li><button id="start_button" class="mg_button_class"><span data-level="2"><img src="lib/img/BT_Memory_Start.png"/></span></button></li>\
									</ul>';
	...
	Memory.prototype._renderTiles = function () {
	  ...
	  <span class="mg__meta--time"><img id="countdown" style="position: fixed; top: 230px; left: 455px; background-color: transparent; border: none;" />\
      <img id="mg__meta--time" style="position: fixed; top: 230px; left: 490px; background-color: transparent; border: none;"  src="lib/img/MemoryGameCount/25.png"/>\
      </span>\
	  </div>';
...
//		this.moveCounterUpdate = document.getElementById("mg__meta--moves").innerHTML = this.numMoves;
	...
	Memory.prototype._loseGame = function () {
		var self = this;
		this._clearGame();
        document.getElementById("MemoryGameAudio").pause();
        ...
        $("#my-memory-game").fadeOut(function() {
	        ...
	        $('#game_over').fadeIn(function() {
	        	...
	        	ajax_addGameResult("game.do", "formType=addGameResult&gameFinalResult=LOST&game=MEMORY_GAME&name=" + code + "&contact=&email=&mediaURL=1.mp4&projectID=velocity");

	    		//Page to stay for 10 seconds before, page navigates to Thank you page
	    
		        setTimeout(function() {
		            $('#game_over').fadeOut();
		            $('#VeloCity_ThankYou').fadeIn(function(){
